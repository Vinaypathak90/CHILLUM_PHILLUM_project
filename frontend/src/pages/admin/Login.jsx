            ...
            {!isForgotPassword && (
                <div className="flex flex-col gap-2">
                    ...
                    <div className="relative">
                        ...
                        {/* 🔥 FIX: Added autoComplete="current-password" here for normal login */}
                        <input type={showPassword ? "text" : "password"} autoComplete="current-password" value={password} onChange={(e) => setPassword(e.target.value)} className="block w-full py-3.5 pl-12 pr-12 bg-[#fcfcfc] border border-gray-200 rounded-xl text-[15px] font-medium focus:outline-none focus:border-[#292e91] focus:ring-[3px] focus:ring-[#292e91]/20 transition-all" placeholder={isLogin ? "Enter Password" : "Create a secure password"} required={!isForgotPassword} />
        ...
        <div className="flex flex-col gap-5 animate-[fadeIn_0.4s_ease-out]">
            ...
            {isForgotPassword && (
                <div className="flex flex-col gap-2 mt-2">
                    ...
                    {/* 🔥 MAIN FIX: type="password" aur autoComplete="new-password" yahan lagaya hai */}
                    <input 
                        type="password" 
                        autoComplete="new-password"
                        value={password} 
                        onChange={(e) => setPassword(e.target.value)} 
                        className="block w-full py-3.5 px-4 bg-[#fcfcfc] border border-gray-200 rounded-xl text-[15px] font-medium focus:outline-none focus:border-[#292e91] focus:ring-[3px] focus:ring-[#292e91]/20 transition-all" 
